...
$fotoProfilF = $rowf['foto_profil'];
$nama = $rowf['nama_fakultas'];
$deskripsi = $rowf['deskripsi'];
                                ...
                                <form id="editProfileForm" enctype="multipart/form-data" action="" method="POST">
                                    <div class="row">
                                        <div class="col-sm-3 col-6">
                                            <img src="../../uploads/<?php echo $fotoProfilF ?>" class="mt-2" style="max-width: 100%; height: auto;">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($fotoprofil)) {
        ...
        if (move_uploaded_file($_FILES['newProfilePicture']['tmp_name'], $targetFilePath)) {
            $querys = "UPDATE fakultas SET nama_fakultas='$nama', deskripsi='$deskripsi', foto_profil='$fotoprofil' WHERE id_fakultas='$id_fakultas'";
        } else {
            echo '<script>
                swal.fire({
                    title: "Error",
        ...
        $querys = "UPDATE fakultas SET nama_fakultas='$nama', deskripsi='$deskripsi' WHERE id_fakultas='$id_fakultas'";
    }
